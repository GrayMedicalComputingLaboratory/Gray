...
GrayCV is a commercial framework baseline, not a production medical-device release.
...
- Device values are only `cpu` or non-negative GPU indexes. Invalid CUDA requests fail explicitly.
