...
| `source/gray/core/provenance.py` | File hashing and legacy flat checkpoint identity manifests. | Experiment orchestration, artifact writing policy or training logic. |
