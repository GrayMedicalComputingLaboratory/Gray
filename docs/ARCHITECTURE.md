...
| `source/gray/experiment/report.py` | Rich visualization of a structured experiment lineage manifest. | Manifest mutation, artifact persistence or model promotion decisions. |
...
| `source/gray/experiment/training_report.py` | Human-readable training configuration and environment version tables. | Training execution, artifact persistence or remote experiment tracking. |
