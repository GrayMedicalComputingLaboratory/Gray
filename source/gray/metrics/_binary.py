...
def binary_inputs(targets: Sequence[Any], probabilities: Sequence[float] | np.ndarray, positive_label: Any | None = None, labels: Sequence[Any] | None = None) -> tuple[np.ndarray, np.ndarray, Any]:
    """Return binary targets, one-dimensional positive probabilities and label."""
